...
//		Ram r=new Ram();
//		r.setName("Dinesh");
//		r.setEmail("Deineshkumar5@gmail.com");
//		System.out.println(r);
//		userRepository.save(r);
		
//		List<Ram> list = userRepository.getAllUSer();
//		list.forEach(jan->{
...
//		});
		...
		// jpql query call
//		List<Ram> list = userRepository.findByName("Rohan");
//		list.forEach(jan->{
//			System.out.println(jan);
//		});
	  ...
	  List<Ram> hi = userRepository.getUserall();
	  hi.forEach(k->{
